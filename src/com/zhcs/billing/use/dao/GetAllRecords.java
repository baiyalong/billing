...
public class GetAllRecords {
	...
	public static OrderInfoBean getProjectOrderInfo(OrderInfoBean orderInfoBean) {
		List<HashMap<String, Object>> list = new GetAllRecords().getProjectOrderInfo(orderInfoBean.getORDER_ID(),"");
		...
		for (OrderDetailBean orderDetailBean : beans) {
			List<ProductInfoBean> productInfoBeans =getProductInfo(orderDetailBean.getPRODUCT_ID());//根据产品编号查询产品信息
	...
	public static List<ProductInfoBean> getProductInfo(String productNo) {
		List<HashMap<String, Object>> list = new GetAllRecords().getProductType(productNo);
		...
		for (ProductInfoBean productInfoBean : beans) {
			List<ProductResourceBean> productResourceBeans = getProductResource(productInfoBean.getPRODUCT_ID());//根据产品编号查询产品资源信息
	...
	public static List<ProductResourceBean> getProductResource(String productNo) {
		List<HashMap<String, Object>> list = new GetAllRecords().getProductDetail(productNo);
		...
		for (ProductResourceBean productResourceBean : beans) {
			if (productResourceBean.getNODE_TYPE() == 8) {//资源下是纬度
				List<ProductItemBean> productItemBeans = getProductItem(productResourceBean.getRESOURCE_ID());
	...
	public static List<ProductItemBean> getProductItem(String resourceNo){
		List<HashMap<String, Object>> list = new GetAllRecords().getProductWDByResourceNo(resourceNo);
	...
	public List<HashMap<String, Object>> getCustomerIdByOrderId(String OrderID){
		...
		cust.add(OrderID);
		List<HashMap<String, Object>> list=GetBaseDao().doSelect(custSQL, cust);
		return list;
	}
	/**
	 * 根据订单编号查询订单明细表
	 ...
	 * @return
	 */
	public  List<HashMap<String, Object>> getProjectOrderInfo(String orderId,String OperationType) {
		// TODO Auto-generated method stub
		//String sql = "SELECT O.PRODUCT_ID FROM PRICE_MODEL P,ORDER_DETAIL O WHERE P.PRODUCT_ID=O.PRODUCT_ID AND O.ORDER_ID=?";
	 ...
	 * @return
	 */
	public List<HashMap<String, Object>> getAppCountsByProductId(String productId){
	 ...
	 * @return
	 */
	public List<HashMap<String, Object>> getResourceIdByProductIdAndAppId(String ProductId,String AppId){
		...
		List<HashMap<String, Object>> list = GetBaseDao().doSelect(resourceSQL, resourceParam);
		resourceParam=null;
		return list;
	}
	/**
	 ...
	 * @return
	 */
	public List<HashMap<String, Object>> getItemByResourceIdAndItmeCode(String resourceId,String itmeCode){
		...
		List<HashMap<String, Object>> list = GetBaseDao().doSelect(itemSQL, itemParam);
		itemParam=null;
		return list;
	}
	/**
	 ...
	 * @return
	 */
	public List<HashMap<String, Object>> getSubscribeAmountByItemId(String itemId){
		String subscribe=VariableConfigManager.getSubscribeAmountByItemId;
		List<String> par=new ArrayList<String>();
		par.add(itemId);
		List<HashMap<String, Object>> list = GetBaseDao().doSelect(subscribe, par);
		par=null;
		return list;
	}
	/**
	 ...
	 * @return
	 */
	public List<HashMap<String, Object>> getPriceByItemId(String itemId,String resourceId){
	 ...
	 * 根据交易流水号查询 维度使用量 
	 */
	public List<HashMap<String, Object>> getDimensionsBySerialNo(String SerialNo,String state){
		//String sql="SELECT * FROM T_USAGE_BAND_TOTAL where STATE=? SALE_ID=?";
	 ...
	 * @throws Exception
	 */
	public void updateUsageBandTotal(String id,String dimension,String updateDate) {
		//String sql = "UPDATE T_USAGE_BAND_TOTAL SET DIMENSIONS = ? AND UPDATE_DATE=? WHERE ID=? ";
	...
	//此方法没用上
	public  List<HashMap<String, Object>> getProductWDByProductNo(String productNo) {
		// TODO Auto-generated method stub
	...
	public List<HashMap<String, Object>> getPriceModelByThreeParams(String productId,String resourceId,String itemId){
		//String sql = "SELECT * FROM PRICE_MODEL where PRODUCT_ID=? AND RESOURCE_ID=? AND ITEM_ID=?";
	...
	public String getPriceModel(ProductItemBean bean) {
		...
		//String sql = " select * from PRICE_MODEL p where p.PRODUCT_ID=? and p.RESOURCE_ID =? and p.ITEM_ID =?";
		...
		List<HashMap<String, Object>> LockDimenList = GetBaseDao().doSelect(sql,params);
