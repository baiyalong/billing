...
public class TGrantPriceForlockDao {
	...
	private static LoggerUtil log = LoggerUtil
			.getLogger(TGrantPriceForlockDao.class);
	...
	/**
	 * 向 锁定确认表(T_USAGE_AFFIRM_TOTAL)表
	 * 插入数据(主键id、交易流水号、产品编号、应用编号、客户编号、维度元组、创建日期、更新日期)
	 * 
	 * @param id
	 * @param SerialNo
	 * @param ProductID
	 ...
	 * @throws Exception
	 */
	public void insertTUsageAffirmTotal(String id, String SerialNo,
			String ProductID, String AppID, String CustomerID,
			String dimensionJSON, String createDate, String updateDate)
			throws Exception {
	...
	/**
	 * 往锁定批价接口详细表(主键id,接口之间的标识符,客户编号,产品编号,应用编号,维度元组,扩展属性,操作类型,交易流水号,时间戳,批价金额,
	 * 批价结果,对错误/异常的详细描述信息,创建日期) 插入数据
	 * 
	 * @param id
	 * @param BillingID
	 * @param CustomerID
	 ...
	 * @throws Exception
	 */
	public void insertTGrantPriceForlock(String id, String BillingID,
			String CustomerID, String ProductID, String AppID,
			String Dimension, String Properties, String OperationType,
			String SerialNo, String TimeStamp, String total, String flag,
			String Description, String createDate) throws Exception {
	 ...
	 * @throws Exception
	 */
	public void insertTUsageBandTotal(String id, String SerialNo,
			String ProductID, String AppID, String CustomerID,
			String dimensionJSON, String createDate, String updateDate)
			throws Exception {
