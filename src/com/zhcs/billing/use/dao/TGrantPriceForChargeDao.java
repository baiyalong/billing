...
public class TGrantPriceForChargeDao {
	private static LoggerUtil log = LoggerUtil
			.getLogger(TGrantPriceForChargeDao.class);
	 ...
	 * @throws Exception
	 */
	public void insertTGrantPriceForcharge(String id, String BillingID,
			String OrderID, String OperationType, String TimeStamp,
			String money, String flag, String Description, String createDate)
			throws Exception {
