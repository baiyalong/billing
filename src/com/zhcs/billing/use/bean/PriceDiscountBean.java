...
public class PriceDiscountBean implements java.io.Serializable{
	...
	public List<PriceDiscountBean> changeToObject(
		...
		for (HashMap<String, Object> hashMap : list) {
			...
			bean.setDISCOUNT_ID(hashMap.get("DISCOUNT_ID") != null ? hashMap.get("DISCOUNT_ID").toString() : null);
			...
			bean.setRULE_CODE(hashMap.get("RULE_CODE") != null ? hashMap.get("RULE_CODE").toString() : null);
			bean.setMIN_VALUE(hashMap.get("MIN_VALUE") != null ? Integer.parseInt(hashMap.get("MIN_VALUE").toString()) : null);
			bean.setMAX_VALUE(hashMap.get("MAX_VALUE") != null ? Integer.parseInt(hashMap.get("MAX_VALUE").toString()) : null);
			bean.setDISCOUNT_VALUE(hashMap.get("DISCOUNT_VALUE") != null ? Integer.parseInt(hashMap.get("DISCOUNT_VALUE").toString()) : null);
			bean.setRATE_VALUE(hashMap.get("RATE_VALUE") != null ? Integer.parseInt(hashMap.get("RATE_VALUE").toString()) : null);
			bean.setDISCOUNT_STATUS(hashMap.get("DISCOUNT_STATUS") != null ? Integer.parseInt(hashMap.get("DISCOUNT_STATUS").toString()) : null);
			beans.add(bean);
		}
		return beans;
	}
