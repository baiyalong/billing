...
public class UsageAccountBean {
	...
	public List<UsageAccountBean> changeToObject(
		...
		for(HashMap<String,Object> d:list){
			...
			usageAccountBean.setCUSTOMER_ID(d.get("CUSTOMER_ID")!=null?d.get("CUSTOMER_ID").toString():null);
			usageAccountBean.setORDER_ID(d.get("ORDER_ID")!=null?d.get("ORDER_ID").toString():null);
			usageAccountBean.setCOMPLETE_STATE(d.get("COMPLETE_STATE")!=null?d.get("COMPLETE_STATE").toString():null);
			usageAccountBean.setSCANNING_TIME_POINT(d.get("SCANNING_TIME_POINT")!=null?d.get("SCANNING_TIME_POINT").toString():null);
			usageAccountBean.setSCANNING_WAY(d.get("SCANNING_WAY")!=null?d.get("SCANNING_WAY").toString():null);
			usageAccountBean.setSERVERS_NO_STATE(d.get("SERVERS_NO_STATE")!=null?Integer.parseInt(d.get("SERVERS_NO_STATE").toString()):null);
			usageAccountBean.setSTATE(d.get("STATE")!=null?d.get("STATE").toString():null);
