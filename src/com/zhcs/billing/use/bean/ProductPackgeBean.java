...
public class ProductPackgeBean implements java.io.Serializable {
	...
	public List<ProductPackgeBean> changeToObject(
		...
		for (HashMap<String, Object> hashMap : list) {
			...
			bean.setPACKAGE_NAME(hashMap.get("PACKAGE_NAME") != null ? hashMap
					.get("PACKAGE_NAME").toString() : null);
			bean.setPACKAGE_PERIOD(hashMap.get("PACKAGE_PERIOD") != null ? Integer
					.parseInt(hashMap.get("PACKAGE_PERIOD").toString()) : null);
			bean.setVALID_FROM(hashMap.get("VALID_FROM") != null ? hashMap.get(
					"VALID_FROM").toString() : null);
			bean.setVALID_TILL(hashMap.get("VALID_TILL") != null ? hashMap.get(
					"VALID_TILL").toString() : null);
			bean.setPACKAGE_PERIOD(hashMap.get("PACKAGE_PERIOD") != null ? Integer
					.parseInt(hashMap.get("PACKAGE_PERIOD").toString()) : null);
			bean.setENABLE_SALE(hashMap.get("ENABLE_SALE") != null ? hashMap
					.get("ENABLE_SALE").toString() : null);
			bean.setPACKAGE_STATUS(hashMap.get("PACKAGE_STATUS") != null ? hashMap
					.get("PACKAGE_STATUS").toString() : null);
			beans.add(bean);
		}
		return beans;
	}
