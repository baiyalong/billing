...
public class PackageDetailBean  implements java.io.Serializable {
	...
	public List<PackageDetailBean> changeToObject(
		...
		for (HashMap<String, Object> hashMap : list) {
			...
			bean.setPD_ID(hashMap.get("PD_ID") != null ? hashMap.get("PD_ID").toString() : null);
			...
			bean.setITEM_AMOUNT(hashMap.get("ITEM_AMOUNT") != null ? Integer.parseInt(hashMap.get("ITEM_AMOUNT").toString()) : null);
			bean.setMEASURE_UNIT(hashMap.get("MEASURE_UNIT") != null ? hashMap.get("MEASURE_UNIT").toString() : null);
