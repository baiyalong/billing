...
public class UsageMonthsBean {
	...
	public List<UsageMonthsBean> changeToObject(
		...
		for (HashMap<String, Object> d : list) {
			...
			usageMonthsBean.setBILLSEQ_ID(d.get("BILLSEQ_ID") != null ? d.get(
					"BILLSEQ_ID").toString() : null);
			usageMonthsBean.setCUSTOMER_ID(d.get("CUSTOMER_ID") != null ? d
					.get("CUSTOMER_ID").toString() : null);
			usageMonthsBean
					.setFIXED_OR_MONTHLY(d.get("FIXED_OR_MONTHLY") != null ? Integer
							.parseInt(d.get("FIXED_OR_MONTHLY").toString())
							: null);
			usageMonthsBean.setSCANNING_WAY(d.get("SCANNING_WAY") != null ? d
					.get("SCANNING_WAY").toString() : null);
			usageMonthsBean.setUNIT_RATE(d.get("UNIT_RATE") != null ? d.get(
					"UNIT_RATE").toString() : null);
			usageMonthsBean.setORDER_ID(d.get("ORDER_ID") != null ? d.get(
					"ORDER_ID").toString() : null);
			usageMonthsBean.setPRODUCT_ID(d.get("PRODUCT_ID") != null ? d.get(
					"PRODUCT_ID").toString() : null);
			usageMonthsBean.setPRODUCT_TYPE(d.get("PRODUCT_TYPE") != null ? d
					.get("PRODUCT_TYPE").toString() : null);
			usageMonthsBean
					.setCOMPLETE_STATE(d.get("COMPLETE_STATE") != null ? d.get(
							"COMPLETE_STATE").toString() : null);
			usageMonthsBean.setSTATE(d.get("STATE") != null ? d.get("STATE")
					.toString() : null);
			usageMonthsBean
					.setSERVERS_NO_STATE(d.get("SERVERS_NO_STATE") != null ? Integer
							...
							: null);
			usageMonthsBean
					.setPRODUCT_CATEGORY(d.get("PRODUCT_CATEGORY") != null ? Integer
							.parseInt(d.get("PRODUCT_CATEGORY").toString())
							: null);
