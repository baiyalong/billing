...
public class TCulOrderDetailBean implements java.io.Serializable {
	...
	public List<TCulOrderDetailBean> changeToObject(
		...
		for (HashMap<String, Object> hashMap : list) {
			...
			bean.setCODE(hashMap.get("CODE") != null ? hashMap.get("CODE")
					.toString() : null);
			bean.setCTYPE(hashMap.get("CTYPE") != null ? hashMap.get("CTYPE")
					.toString() : null);
			bean.setBEFORE_AMOUNT(hashMap.get("BEFORE_AMOUNT") != null ? hashMap
					.get("BEFORE_AMOUNT").toString() : null);
			bean.setAFTER_AMOUNT(hashMap.get("AFTER_AMOUNT") != null ? hashMap
					.get("AFTER_AMOUNT").toString() : null);
			bean.setCOUNT_COST(hashMap.get("COUNT_COST") != null ? hashMap.get(
					"COUNT_COST").toString() : null);
			bean.setDEDUCT_COST(hashMap.get("DEDUCT_COST") != null ? hashMap
					.get("DEDUCT_COST").toString() : null);
			bean.setREALITY(hashMap.get("REALITY") != null ? hashMap.get(
					"REALITY").toString() : null);
			bean.setSCANNING_TIME(hashMap.get("SCANNING_TIME") != null ? hashMap
					.get("SCANNING_TIME").toString() : null);
