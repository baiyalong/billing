...
public class UnLockGrantPrice implements Job {
	...
	private static LoggerUtil logUtil = LoggerUtil
			.getLogger(UnLockGrantPrice.class);
	...
	public void execute(JobExecutionContext arg0) throws JobExecutionException {
		...
		try {
			i = billing
					.doSaveOrUpdate("UPDATE T_USAGE_BAND_TOTAL SET STATE='0' WHERE STATE NOT IN(0) AND TIMESTAMPDIFF(MINUTE,CREATE_DATE,current_timestamp())>215");
			if (i > 0) {
