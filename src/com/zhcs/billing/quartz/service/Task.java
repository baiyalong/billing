...
//	}
	...
	public void execute(JobExecutionContext context)throws JobExecutionException {
		...
		try {
			...
			// 任务执行前，先记录个日志。
//			String inSql = "INSERT INTO T_TASK_LOG(TASK_ID,REMARKS,START_DATE,STATE) VALUES(? , '执行中' , NOW() , 'R' )";
			...
			execute(map); //任务执行
			// 执行完成更新下任务日志
//			String upSql = "UPDATE T_TASK_LOG SET STATE='O',REMARKS='执行完成',FINISH_DATE=NOW() WHERE TASK_LOG_ID=?";
			...
			try {
				// 异常了，更新下任务日志，说明是异常的
//				String sql = "UPDATE T_TASK_LOG SET STATE='E',FINISH_DATE=NOW(),REMARKS=? WHERE TASK_LOG_ID=? ";
